<%@ Page Title="" Language="C#" MasterPageFile="~/Program/Program.Master" AutoEventWireup="true" CodeBehind="Program_Mutfak.aspx.cs" Inherits="ProCafe.Program.Program_Mutfak" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMiddle" runat="server">
    <uc1:Kasa_Mutfak_User_Control ID="Kasa_Mutfak_User_ControlProgramMutfak" runat="server" />
</asp:Content>
