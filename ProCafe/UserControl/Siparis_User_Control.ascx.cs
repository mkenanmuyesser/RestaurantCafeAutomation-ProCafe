...
{
    public partial class Siparis_User_Control : System.Web.UI.UserControl
    {
        ...
        public string SiparisTip
        {
            get
            {
                string siparistip = Request.QueryString["SiparisTip"];
                return siparistip;
            }
        }
        ...
        protected void RepeaterKategori_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            var linkButtonKategori = e.Item.FindControl(PageControl.LinkButtonKategori) as LinkButton;
            linkButtonKategori.CommandArgument = _T_Urun_Kategori_Tur.UrunKategoriTurKey.ToString();
            var radBinaryImageKategori = e.Item.FindControl(PageControl.RadBinaryImageKategori) as RadBinaryImage;
        ...
        protected void RadButtonEkranKapat_Click(object sender, EventArgs e)
        {
            var _RadButton = sender as RadButton;
            switch (_RadButton.ID)
            {
                case "RadButtonEkranKapat1":
        ...
        private void SetInitialValues()
        {
            ...
            switch (SiparisTip)
            {
                case "M":
                    //Mutfak
                    RadButtonEkranKapat1.Visible = true;
                ...
                case "P":
                    //Paket
                    RadButtonEkranKapat2.Visible = true;
                    PanelMasaSiparis.Visible = false;
                    break;
            }
        ...
        private void PencereKapat1()
        {
            string script = "<script language='javascript' type='text/javascript'>CloseOnReload1()</script>";
            Page.ClientScript.RegisterStartupScript(GetType(), "CloseOnReload1", script);
        }

        private void PencereKapat2()
        {
            string script = "<script language='javascript' type='text/javascript'>CloseOnReload2()</script>";
            Page.ClientScript.RegisterStartupScript(GetType(), "CloseOnReload2", script);
        }
