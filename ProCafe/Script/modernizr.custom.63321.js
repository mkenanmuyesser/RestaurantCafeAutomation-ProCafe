...
window.Modernizr = function(a, b, c) {
    ...
    !A(w, "undefined") && !A(w.call, "undefined") ? x = function(a, b) { return w.call(a, b); } : x = function(a, b) { return b in a && A(a.constructor.prototype[b], "undefined"); }, Function.prototype.bind || (Function.prototype.bind = function(b) {
        ...
        return e;
    }), q.boxshadow = function() { return E("boxShadow"); };
    ...
    return e.input || F(), e.addTest = function(a, b) {
        ...
        a.html5 = r, q(b);
    }(this, b), e._version = d, e._domPrefixes = p, e._cssomPrefixes = o, e.testProp = function(a) { return C([a]); }, e.testAllProps = E, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + t.join(" ") : ""), e;
